...
ATT.Category = {"bocw_lc10_underbarrel", "bocw_tec9_underbarrel", "bocw_lapa_underbarrel"}
...
ATT.PrintName = "Patrol Grip" -- UGR
ATT.CompactName = "PATROL GRIP"
ATT.Icon = Material("entities/bocw_atts/underbarrels/ugr_patrol.png", "mips smooth")
ATT.Description = [[Repurposed wood pistol grip for improved sprint speed and sprint recovery time.
...
ARC9.LoadAttachment(ATT, "bocw_ugr_underbarrel_patrolgrip")
...
ATT.PrintName = "Bruiser Grip" -- UGR
ATT.CompactName = "BRUISER"
ATT.Icon = Material("entities/bocw_atts/underbarrels/ugr_bruiser.png", "mips smooth")
ATT.Description = [[Short wooden foregrip for faster weapon melee combat and movement speeds.
...
ARC9.LoadAttachment(ATT, "bocw_ugr_underbarrel_bruisergrip")
